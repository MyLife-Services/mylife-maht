...
export async function play(){
    ...
    if(!context.activismBotId){
        console.log('  ✗ Cannot run — no activismBotId in context. Run Score 17 first.')
    ...
    if(!actionId){
        movements.push(movement('Verify action in collections', null, ()=>({ passed: false, learned: {}, notes: 'Skipped — no actionId from movement 1' })))
