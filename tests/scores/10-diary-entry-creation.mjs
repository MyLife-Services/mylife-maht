...
export async function play(){
    ...
    if(!context.diaryBotId){
        console.log('  ✗ Cannot run — no diaryBotId in context. Run Score 09 first.')
    ...
    if(!entryId){
        movements.push(movement('Verify entry in collections', null, ()=>({ passed: false, learned: {}, notes: 'Skipped — no entryId' })))
