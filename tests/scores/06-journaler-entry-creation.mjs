...
export async function play(){
    ...
    if(!context.journalerBotId){
        console.log('  ✗ Cannot run — no journalerBotId in context. Run Score 05 first.')
    ...
    if(!entryId){
        movements.push(movement('Verify entry in collections', null, ()=>({ passed: false, learned: {}, notes: 'Skipped — no entryId from movement 1' })))
