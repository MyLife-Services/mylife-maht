...
export async function play(){
    ...
    if(!context.politicalStanceBotId){
        console.log('  ✗ Cannot run — no politicalStanceBotId in context. Run Movement 13 first.')
    ...
    if(!stanceId){
        sections.push(section('Verify stance in collections', null, ()=>({ passed: false, learned: {}, notes: 'Skipped — no stanceId from movement 1' })))
